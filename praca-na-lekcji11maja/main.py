...
# plt.show()
#
# #możemy też ustawić różne kolory dla poszczególnych
# # elementów nakładając na siebie dwa wykresy
...
# #wykresy mogą być też dodawane do płótna definicja
# # po definicji zamiast w pojedynczym wywołaniu funkcji plot()
# #tutaj użyty został również parametr label, który określa etykietę
# # danego wykresu w legendzie
...
# # binsoznacza ilość "koszy" czyli słupków, do których mają wpadać wartości z wektora x
